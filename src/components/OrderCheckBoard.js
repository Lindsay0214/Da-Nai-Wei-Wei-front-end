      ...
      <div className="w-full h-auto bg-yellow-default">
        ...
        <div className="w-5/6 h-auto pb-10 m-auto bg-white rounded-lg lg:w-8/12 lg:h-5/6">
          ...
          <div>
            ...
            <div className="flex w-9/12 mb-8 ml-12 rounded-lg h-36 lg:w-1/4 lg:mt-20 lg:mb-14 lg:h-48 lg:ml-32 bg-yellow-hover">
          ...
          <div className="w-4/5 m-auto border-t-2 border-black border-opacity-40">
            ...
            <div className="w-10/12 lg:w-9/12 p-2.5 m-auto rounded-lg bg-yellow-hover h-1/5 lg:p-7">
