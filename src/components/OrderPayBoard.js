const OrderBoard = () => {
  return (
    <>
      <div className="h-auto p-10 bg-yellow-default">
        <ul className="flex justify-around w-full mx-auto -mt-12">
      ...
      <div className="absolute w-full h-full bg-yellow-default">
        <div className="w-5/6 h-auto pb-10 m-auto bg-white rounded-lg lg:w-8/12 lg:h-5/6">
          <h1 className="flex justify-center w-4/5 py-6 m-auto text-xl text-black lg:py-10 lg:text-4xl border-opacity-60 font-seminole">
            訂單完成
          </h1>
          <div className="flex w-4/5 m-auto">
            <div className="flex justify-start w-10 h-10 mt-6 rounded-full ml-9lg:w-20 lg:h-20 lg:mt-24 lg:ml-32 bg-yellow-hover"></div>
            <p className="h-6 mt-8 ml-3.5 mb-10 text-base lg:mt-32 lg:ml-6lg:text-xl lg:mb-28">
              王小明
            </p>
            <p className="h-6 mt-8 ml-3.5 mb-10 text-base lg:text-xl lg:mt-36lg:-ml-14 lg:mb-28">
              0911-123-321
            </p>
          </div>
