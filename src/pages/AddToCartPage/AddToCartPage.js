...
const AddToCartPage = () => {
  return (
    <div className="flex items-center justify-center bg-yellow-default">
      <div className="w-screen m-20 bg-white rounded md:w-96">
        ...
        <div className="m-10 mx-5 text-xs md:mx-8 md:text-base">
          ...
          <button
            className="hover:bg-yellow-noted hover:text-white hover:border-white  py-1.5 rounded border border-gray-default mt-6 px-16 ml-6 md:ml-20"
            type="button"
          >
            確認
          </button>
