  ...
  return (
    <div className="flex-col bg-yellow-lightYellow">
      ...
      <div className="flex-col w-64 p-2 m-auto bg-white rounded-md lg:bg-yellow-lightYellow lg:w-176 ">
        ...
        <div className="flex flex-col-reverse w-40 h-20 m-auto text-left rounded-md lg:h-36 lg:w-72 bg-gray-default lg:bg-white bg-opacity-60 my-11">
          <span className="pb-2 pl-4 text-sm">XXXX-XXXX-XXXX-XXXX</span>
        </div>
        <div className="flex justify-center w-40 pb-8 m-auto lg:w-128 ">
