  ...
  return (
    <div className="bg-yellow-default">
      <div className="flex h-screen">
        <div className="pt-16 m-auto mt-8 bg-white rounded pb-96 md:pt-20 w-80 md:w-3/6 mb-36 h-4/6">
          ...
          <div className="flex flex-col items-center justify-center m-auto my-10 w-80">
            ...
            <input
              placeholder="密碼"
              className="flex-col p-2 mt-4 font-light rounded w-60 bg-gray-input md:w-80"
            ></input>
            <input
              placeholder="密碼確認"
              className="flex-col p-2 mt-4 font-light rounded w-60 bg-gray-input md:w-80"
